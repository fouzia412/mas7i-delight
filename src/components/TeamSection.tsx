      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          >
            ...
            <span className="text-primary font-semibold text-sm">The People Behind MAS7i</span>
          </motion.div>
          <h2 className="text-4xl md:text-5xl font-bold text-text-light mt-4">
            Meet Our <span className="text-primary">Team</span>
          </h2>
          <p className="text-text-light/60 mt-4 max-w-2xl mx-auto">
        ...
        <div className="mb-20">
          <div className="flex items-center justify-center gap-3 mb-10" data-aos="fade-up">
            ...
            <h3 className="text-2xl font-bold text-text-light">Leadership Team</h3>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {leaders.map((leader, index) => (
              ...
              >
                {/* Glowing Border */}
                <div className="absolute -inset-0.5 bg-gradient-to-r from-primary via-primary/50 to-primary rounded-3xl opacity-0 group-hover:opacity-100 blur transition-opacity duration-500" />
                  ...
                  <div className="grid md:grid-cols-2 gap-0">
                    ...
                    <div className="relative h-80 md:h-full overflow-hidden">
                      ...
                      <motion.div
                        initial={{ x: -100 }}
                        whileInView={{ x: 0 }}
                        className="absolute top-4 left-4 flex items-center gap-2 px-3 py-1.5 bg-primary rounded-full"
                      >
                        <Crown className="w-4 h-4 text-primary-foreground" />
                        <span className="text-xs font-bold text-primary-foreground">LEAD</span>
                      </motion.div>
                    ...
                    <div className="p-6 md:p-8 flex flex-col justify-center">
                      <span className="text-primary text-sm font-medium mb-1">{leader.department}</span>
                      <h3 className="text-2xl font-bold text-text-light mb-1">{leader.name}</h3>
                      <p className="text-primary font-semibold mb-4">{leader.role}</p>
                      <p className="text-text-light/70 text-sm line-clamp-3 mb-4">
                        {leader.description}
                      </p>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-primary/50 transition-colors duration-300">
                  {/* Hexagon-style image container */}
                  <div className="relative pt-8 px-8">
                    ...
                    <motion.div
                      ...
                      className="absolute top-4 right-4 px-3 py-1 bg-primary text-primary-foreground text-xs font-medium rounded-full"
                    >
                      {member.department}
                    </motion.div>
                  </div>
                    ...
                    <div className="flex justify-center gap-2">
                      {member.social?.linkedin && (
                        <motion.a
                          ...
                          className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center text-text-light/70 hover:bg-primary hover:text-primary-foreground transition-colors"
                          onClick={(e) => e.stopPropagation()}
                        >
                ...
                <div className="relative h-64 overflow-hidden rounded-t-3xl">
                  ...
                  {selectedMember.isLead && (
                    <div className="absolute top-4 left-4 flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
                      <Crown className="w-4 h-4 text-primary-foreground" />
                      <span className="text-sm font-bold text-primary-foreground">LEAD</span>
                    </div>
                  )}
                  ...
                  <div className="flex gap-3">
                    {selectedMember.social?.linkedin && (
                      <motion.a
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full text-text-light hover:bg-primary hover:text-primary-foreground transition-colors"
                      >
                        <Linkedin className="w-5 h-5" />
